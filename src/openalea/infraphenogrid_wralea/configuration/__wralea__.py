...
__name__ = 'openalea.infraphenogrid.configuration'
...
Phenomenal_configreader = Factory(name='configreader',
                               ...
                               category='Data I/O',
                               nodemodule = 'openalea.infraphenogrid.configuration',
                               nodeclass = 'getconfig',
...
Phenomenal_sidebinconfiguration = Factory(name='sidebin_configuration',
                               ...
                               inputs=[{'interface': None, 'name': 'configuration', 'desc': 'config parser'}],
